...
{
    internal sealed class AcrylicShadowDrawOperation : ICustomDrawOperation
    {
        ...
        public AcrylicShadowDrawOperation(Rect controlBounds, AcrylicDrawParameters parameters)
        {
        ...
        public void Render(ImmediateDrawingContext context)
        {
            ...
            float[] cornerRadii = AcrylicPathUtils.GetCornerRadii(_parameters.CornerRadius, maxRadius);
            SKRect rect = SKRect.Create(0, 0, size.Width, size.Height);

            using SKPath path = AcrylicPathUtils.CreateRoundRectPath(rect, cornerRadii);
    ...
    internal sealed class AcrylicInnerShadowDrawOperation : ICustomDrawOperation
    {
        private readonly Rect _bounds;
        private readonly AcrylicDrawParameters _parameters;

        public AcrylicInnerShadowDrawOperation(Rect bounds, AcrylicDrawParameters parameters)
        {
            _bounds = bounds;
            _parameters = parameters;
        }
