...
{
    public readonly struct AcrylicDiagnosticsSnapshot
    {
        internal AcrylicDiagnosticsSnapshot(
    ...
    public static class AcrylicDiagnostics
    {
        ...
        public static AcrylicDiagnosticsSnapshot Snapshot
        {
            get => new(
