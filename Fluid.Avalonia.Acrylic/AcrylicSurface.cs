...
namespace Fluid.Avalonia.Acrylic
{
    ...
    /// </summary>
    public class AcrylicSurface : ContentControl
    {
        public static readonly StyledProperty<double> BackdropZoomProperty =
            AvaloniaProperty.Register<AcrylicSurface, double>(nameof(BackdropZoom), 1.0);

        public static readonly StyledProperty<Vector> BackdropOffsetProperty =
            AvaloniaProperty.Register<AcrylicSurface, Vector>(nameof(BackdropOffset), new Vector(0.0, 0.0));

        public static readonly StyledProperty<double> RefractionHeightProperty =
            AvaloniaProperty.Register<AcrylicSurface, double>(nameof(RefractionHeight), 12.0);

        public static readonly StyledProperty<double> RefractionAmountProperty =
            AvaloniaProperty.Register<AcrylicSurface, double>(nameof(RefractionAmount), 24.0);

        public static readonly StyledProperty<bool> DepthEffectProperty =
            AvaloniaProperty.Register<AcrylicSurface, bool>(nameof(DepthEffect), false);

        public static readonly StyledProperty<bool> ChromaticAberrationProperty =
            AvaloniaProperty.Register<AcrylicSurface, bool>(nameof(ChromaticAberration), false);

        public static readonly StyledProperty<double> BlurRadiusProperty =
            AvaloniaProperty.Register<AcrylicSurface, double>(nameof(BlurRadius), 2.0);

        public static readonly StyledProperty<double> VibrancyProperty =
            AvaloniaProperty.Register<AcrylicSurface, double>(nameof(Vibrancy), 1.5);

        public static readonly StyledProperty<double> BrightnessProperty =
            AvaloniaProperty.Register<AcrylicSurface, double>(nameof(Brightness), 0.0);

        public static readonly StyledProperty<double> ContrastProperty =
            AvaloniaProperty.Register<AcrylicSurface, double>(nameof(Contrast), 1.0);

        public static readonly StyledProperty<double> ExposureEvProperty =
            AvaloniaProperty.Register<AcrylicSurface, double>(nameof(ExposureEv), 0.0);

        public static readonly StyledProperty<double> GammaPowerProperty =
            AvaloniaProperty.Register<AcrylicSurface, double>(nameof(GammaPower), 1.0);

        public static readonly StyledProperty<double> BackdropOpacityProperty =
            AvaloniaProperty.Register<AcrylicSurface, double>(nameof(BackdropOpacity), 1.0);

        public static readonly StyledProperty<Color> TintColorProperty =
            AvaloniaProperty.Register<AcrylicSurface, Color>(nameof(TintColor), Colors.Transparent);

        public static readonly StyledProperty<Color> SurfaceColorProperty =
            AvaloniaProperty.Register<AcrylicSurface, Color>(nameof(SurfaceColor), Colors.Transparent);

        public static readonly StyledProperty<bool> ProgressiveBlurEnabledProperty =
            AvaloniaProperty.Register<AcrylicSurface, bool>(nameof(ProgressiveBlurEnabled), false);
        ...
        public static readonly StyledProperty<double> ProgressiveBlurStartProperty =
            AvaloniaProperty.Register<AcrylicSurface, double>(nameof(ProgressiveBlurStart), 0.5);
        ...
        public static readonly StyledProperty<double> ProgressiveBlurEndProperty =
            AvaloniaProperty.Register<AcrylicSurface, double>(nameof(ProgressiveBlurEnd), 1.0);

        public static readonly StyledProperty<Color> ProgressiveTintColorProperty =
            AvaloniaProperty.Register<AcrylicSurface, Color>(nameof(ProgressiveTintColor), Colors.Transparent);

        public static readonly StyledProperty<double> ProgressiveTintIntensityProperty =
            AvaloniaProperty.Register<AcrylicSurface, double>(nameof(ProgressiveTintIntensity), 0.8);

        public static readonly StyledProperty<bool> AdaptiveLuminanceEnabledProperty =
            AvaloniaProperty.Register<AcrylicSurface, bool>(nameof(AdaptiveLuminanceEnabled), false);

        public static readonly StyledProperty<double> AdaptiveLuminanceUpdateIntervalMsProperty =
            AvaloniaProperty.Register<AcrylicSurface, double>(nameof(AdaptiveLuminanceUpdateIntervalMs), 250.0);

        public static readonly StyledProperty<double> AdaptiveLuminanceSmoothingProperty =
            AvaloniaProperty.Register<AcrylicSurface, double>(nameof(AdaptiveLuminanceSmoothing), 0.2);

        public static readonly DirectProperty<AcrylicSurface, double> AdaptiveLuminanceProperty =
            AvaloniaProperty.RegisterDirect<AcrylicSurface, double>(
                nameof(AdaptiveLuminance),
                o => o.AdaptiveLuminance);

        public static readonly StyledProperty<bool> HighlightEnabledProperty =
            AvaloniaProperty.Register<AcrylicSurface, bool>(nameof(HighlightEnabled), true);

        public static readonly StyledProperty<double> HighlightWidthProperty =
            AvaloniaProperty.Register<AcrylicSurface, double>(nameof(HighlightWidth), 0.5);

        public static readonly StyledProperty<double> HighlightBlurRadiusProperty =
            AvaloniaProperty.Register<AcrylicSurface, double>(nameof(HighlightBlurRadius), 0.25);

        public static readonly StyledProperty<double> HighlightOpacityProperty =
            AvaloniaProperty.Register<AcrylicSurface, double>(nameof(HighlightOpacity), 0.5);

        public static readonly StyledProperty<double> HighlightAngleProperty =
            AvaloniaProperty.Register<AcrylicSurface, double>(nameof(HighlightAngle), 45.0);

        public static readonly StyledProperty<double> HighlightFalloffProperty =
            AvaloniaProperty.Register<AcrylicSurface, double>(nameof(HighlightFalloff), 1.0);

        public static readonly StyledProperty<bool> ShadowEnabledProperty =
            AvaloniaProperty.Register<AcrylicSurface, bool>(nameof(ShadowEnabled), true);

        public static readonly StyledProperty<double> ShadowRadiusProperty =
            AvaloniaProperty.Register<AcrylicSurface, double>(nameof(ShadowRadius), 24.0);

        public static readonly StyledProperty<Vector> ShadowOffsetProperty =
            AvaloniaProperty.Register<AcrylicSurface, Vector>(nameof(ShadowOffset), new Vector(0.0, 4.0));

        public static readonly StyledProperty<Color> ShadowColorProperty =
            AvaloniaProperty.Register<AcrylicSurface, Color>(nameof(ShadowColor), Color.FromArgb(26, 0, 0, 0));
        ...
        public static readonly StyledProperty<double> InnerShadowRadiusProperty =
            AvaloniaProperty.Register<AcrylicSurface, double>(nameof(InnerShadowRadius), 24.0);

        public static readonly StyledProperty<Vector> InnerShadowOffsetProperty =
            AvaloniaProperty.Register<AcrylicSurface, Vector>(nameof(InnerShadowOffset), new Vector(0.0, 24.0));

        public static readonly StyledProperty<Color> InnerShadowColorProperty =
            AvaloniaProperty.Register<AcrylicSurface, Color>(nameof(InnerShadowColor), Color.FromArgb(38, 0, 0, 0));

        public static readonly StyledProperty<double> InnerShadowOpacityProperty =
            AvaloniaProperty.Register<AcrylicSurface, double>(nameof(InnerShadowOpacity), 1.0);

        static AcrylicSurface()
        {
            ...
            ClipToBoundsProperty.OverrideDefaultValue<AcrylicSurface>(false);

            AffectsRender<AcrylicSurface>(
            ...
            TemplateProperty.OverrideDefaultValue<AcrylicSurface>(CreateDefaultTemplate());
        }

        internal AcrylicInteractiveOverlay? InteractiveOverlay { get; private set; }
        ...
        public override void Render(DrawingContext context)
        {
            ...
            AcrylicDrawParameters parameters = CreateDrawParameters();
            ...
            if (ShadowEnabled && ShadowOpacity > 0.001 && ShadowColor.A > 0 && ShadowRadius > 0.001)
                context.Custom(new AcrylicShadowDrawOperation(controlBounds, parameters));

            AcrylicBackdropProvider.EnsureSnapshot(this);
            AcrylicBackdropSnapshot? snapshot = AcrylicBackdropProvider.TryGetSnapshot(this);

            context.Custom(new AcrylicDrawOperation(controlBounds, parameters, snapshot, AcrylicDrawPass.Lens));
        }

        internal AcrylicDrawParameters CreateDrawParameters()
        {
            AcrylicDrawParameters parameters = new()
            {
        ...
        protected override void OnApplyTemplate(TemplateAppliedEventArgs e)
        {
            ...
            InteractiveOverlay = e.NameScope.Find<AcrylicInteractiveOverlay>("PART_InteractiveOverlay");
            FrontOverlay = e.NameScope.Find<AcrylicFrontOverlay>("PART_FrontOverlay");
        }
        ...
        {
            return new FuncControlTemplate<AcrylicSurface>((_, ns) =>
            {
                AcrylicInteractiveOverlay interactiveOverlay = new AcrylicInteractiveOverlay
                {
                ...
                AcrylicFrontOverlay frontOverlay = new AcrylicFrontOverlay
                {
