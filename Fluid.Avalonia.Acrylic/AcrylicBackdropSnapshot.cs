...
{
    internal sealed class AcrylicBackdropSnapshot : IDisposable
    {
        ...
        public AcrylicBackdropSnapshot(SKImage image, PixelPoint originInPixels, PixelSize pixelSize, double scaling)
        {
            Image = image ?? throw new ArgumentNullException(nameof(image));
            OriginInPixels = originInPixels;
            PixelSize = pixelSize;
